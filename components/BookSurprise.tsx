  ...
  return (
    <div className="surprise-overlay book-mode">
      ...
      <motion.div className="surprise-scene" initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
        <motion.div className="sam-gift-figure book-figure" initial={{ y: 70, opacity: 0 }} animate={{ y: 0, opacity: 1 }} transition={{ type: "spring", damping: 18 }}>
          <img src="/assets/sam.png" alt="Sam" />
          <motion.div className="book-prop" initial={{ rotateY: -70, scale: 0.65 }} animate={{ rotateY: 0, scale: 1 }} transition={{ delay: 0.65, duration: 0.9 }}>
